...
// ---- helper (TOP-LEVEL, not inside JSX) ----
...
export default function Page() {
  return (
    <main>
      ...
      {/* Experience */}
      <section id="experience" className="container py-16 md:py-24 border-t border-neutral-200/60 dark:border-neutral-800">
        <header className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Experience</h2>
          <p className="mt-2 text-neutral-600 dark:text-neutral-300">Roles, projects, and outcomes.</p>
        </header>
      ...
      {/* Stack */}
      <section id="stack" className="container py-16 md:py-24 border-t border-neutral-200/60 dark:border-neutral-800">
        <header className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Tech Stack</h2>
          <p className="mt-2 text-neutral-600 dark:text-neutral-300">Tools I reach for often.</p>
        </header>
